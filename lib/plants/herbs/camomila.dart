...
class abrirPaginaCamomila extends StatefulWidget {

  @override
  State<abrirPaginaCamomila> createState() => _abrirPaginaCamomilaState();
}

class _abrirPaginaCamomilaState extends State<abrirPaginaCamomila> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaCamomila(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaCamomila extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaCamomila> createState() => _conteudoPaginaAbertaCamomilaState();
}

class _conteudoPaginaAbertaCamomilaState extends State<conteudoPaginaAbertaCamomila> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants camomila = myBox.get('herb3');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(camomila.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(camomila.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(camomila.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(camomila.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
