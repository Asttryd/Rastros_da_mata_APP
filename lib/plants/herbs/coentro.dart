...
class abrirPaginaCoentro extends StatefulWidget {

  @override
  State<abrirPaginaCoentro> createState() => _abrirPaginaCoentroState();
}

class _abrirPaginaCoentroState extends State<abrirPaginaCoentro> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaCoentro(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaCoentro extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaCoentro> createState() => _conteudoPaginaAbertaCoentroState();
}

class _conteudoPaginaAbertaCoentroState extends State<conteudoPaginaAbertaCoentro> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants coentro = myBox.get('herb1');
    return Center(
      child: SingleChildScrollView(
        child: Column(
          children: [
            Padding(padding: EdgeInsets.all(10)),
            Text(coentro.observations,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(coentro.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(coentro.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
