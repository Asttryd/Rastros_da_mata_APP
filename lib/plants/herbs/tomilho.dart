...
class abrirPaginaTomilho extends StatefulWidget {

  @override
  State<abrirPaginaTomilho> createState() => _abrirPaginaTomilhoState();
}

class _abrirPaginaTomilhoState extends State<abrirPaginaTomilho> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaTomilho(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaTomilho extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaTomilho> createState() => _conteudoPaginaAbertaTomilhoState();
}

class _conteudoPaginaAbertaTomilhoState extends State<conteudoPaginaAbertaTomilho> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants tomilho = myBox.get('herb4');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(tomilho.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(tomilho.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
