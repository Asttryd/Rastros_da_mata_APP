...
class abrirPaginaHortela extends StatefulWidget {

  @override
  State<abrirPaginaHortela> createState() => _abrirPaginaHortelaState();
}

class _abrirPaginaHortelaState extends State<abrirPaginaHortela> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaHortela(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaHortela extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaHortela> createState() => _conteudoPaginaAbertaHortelaState();
}

class _conteudoPaginaAbertaHortelaState extends State<conteudoPaginaAbertaHortela> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants hortela = myBox.get('herb1');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(hortela.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(hortela.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
