...
class abrirPaginaAbacaxi extends StatefulWidget {

  @override
  State<abrirPaginaAbacaxi> createState() => _abrirPaginaAbacaxiState();
}

class _abrirPaginaAbacaxiState extends State<abrirPaginaAbacaxi> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaAbacaxi(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaAbacaxi extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaAbacaxi> createState() => _conteudoPaginaAbertaAbacaxiState();
}

class _conteudoPaginaAbertaAbacaxiState extends State<conteudoPaginaAbertaAbacaxi> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants abacaxi = myBox.get('fruit3');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(abacaxi.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(abacaxi.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
