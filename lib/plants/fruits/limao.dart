...
import '../../models.dart';
import '../../plants.dart';
class abrirPaginaLimao extends StatefulWidget {

  @override
  State<abrirPaginaLimao> createState() => _abrirPaginaLimaoState();
}

class _abrirPaginaLimaoState extends State<abrirPaginaLimao> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaLimao(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaLimao extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaLimao> createState() => _conteudoPaginaAbertaLimaoState();
}

class _conteudoPaginaAbertaLimaoState extends State<conteudoPaginaAbertaLimao> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants limao = myBox.get('fruit6');
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(limao.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
