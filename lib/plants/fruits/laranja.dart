...
class abrirPaginaLaranja extends StatefulWidget {

  @override
  State<abrirPaginaLaranja> createState() => _abrirPaginaLaranjaState();
}

class _abrirPaginaLaranjaState extends State<abrirPaginaLaranja> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaLaranja(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaLaranja extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaLaranja> createState() => _conteudoPaginaAbertaLaranjaState();
}

class _conteudoPaginaAbertaLaranjaState extends State<conteudoPaginaAbertaLaranja> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants laranja = myBox.get('fruit5');
        ...
        child: Column(
          children: [
            Padding(padding: EdgeInsets.fromLTRB(20, 10, 20, 0),
              child: Text(laranja.observations,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(laranja.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(laranja.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
