...
class abrirPaginaAbacate extends StatefulWidget {

  @override
  State<abrirPaginaAbacate> createState() => _abrirPaginaAbacateState();
}

class _abrirPaginaAbacateState extends State<abrirPaginaAbacate> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaAbacate(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaAbacate extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaAbacate> createState() => _conteudoPaginaAbertaAbacateState();
}

class _conteudoPaginaAbertaAbacateState extends State<conteudoPaginaAbertaAbacate> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants abacate = myBox.get('fruit4');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(abacate.description,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(abacate.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
