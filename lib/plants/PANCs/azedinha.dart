...
class abrirPaginaAzedinha extends StatefulWidget {

  @override
  State<abrirPaginaAzedinha> createState() => _abrirPaginaAzedinhaState();
}

class _abrirPaginaAzedinhaState extends State<abrirPaginaAzedinha> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaAzedinha(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaAzedinha extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaAzedinha> createState() => _conteudoPaginaAbertaAzedinhaState();
}

class _conteudoPaginaAbertaAzedinhaState extends State<conteudoPaginaAbertaAzedinha> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants azedinha = myBox.get('PANC1');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(azedinha.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(azedinha.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(azedinha.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(azedinha.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
