...
class abrirPaginaPeixinho extends StatefulWidget {

  @override
  State<abrirPaginaPeixinho> createState() => _abrirPaginaPeixinhoState();
}

class _abrirPaginaPeixinhoState extends State<abrirPaginaPeixinho> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaPeixinho(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaPeixinho extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaPeixinho> createState() => _conteudoPaginaAbertaPeixinhoState();
}

class _conteudoPaginaAbertaPeixinhoState extends State<conteudoPaginaAbertaPeixinho> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants peixinho = myBox.get('PANC5');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(peixinho.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(peixinho.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(peixinho.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(peixinho.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
