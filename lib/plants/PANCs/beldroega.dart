...
class abrirPaginaBeldroega extends StatefulWidget {

  @override
  State<abrirPaginaBeldroega> createState() => _abrirPaginaBeldroegaState();
}

class _abrirPaginaBeldroegaState extends State<abrirPaginaBeldroega> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaBeldroega(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaBeldroega extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaBeldroega> createState() => _conteudoPaginaAbertaBeldroegaState();
}

class _conteudoPaginaAbertaBeldroegaState extends State<conteudoPaginaAbertaBeldroega> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants beldroega = myBox.get('PANC1');
    return Center(
      child: SingleChildScrollView(
        child: Column(
          children: [
            Padding(padding: EdgeInsets.all(10)),
            Text(beldroega.observations,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(beldroega.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(beldroega.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(beldroega.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(beldroega.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
