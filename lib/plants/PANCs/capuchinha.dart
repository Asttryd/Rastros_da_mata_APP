...
class abrirPaginaCapuchinha extends StatefulWidget {

  @override
  State<abrirPaginaCapuchinha> createState() => _abrirPaginaCapuchinhaState();
}

class _abrirPaginaCapuchinhaState extends State<abrirPaginaCapuchinha> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaCapuchinha(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaCapuchinha extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaCapuchinha> createState() => _conteudoPaginaAbertaCapuchinhaState();
}

class _conteudoPaginaAbertaCapuchinhaState extends State<conteudoPaginaAbertaCapuchinha> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants capuchinha = myBox.get('PANC1');
    return Center(
      child: SingleChildScrollView(
        child: Column(
          children: [
            Padding(padding: EdgeInsets.all(10)),
            Text(capuchinha.observations,
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(capuchinha.developmentEta,
                      style: TextStyle(
                        color: Color.fromARGB(255, 87, 87, 87),
                        fontFamily: 'Antic',
                        fontSize: 15,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(capuchinha.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(capuchinha.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(capuchinha.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(capuchinha.planting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(capuchinha.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
