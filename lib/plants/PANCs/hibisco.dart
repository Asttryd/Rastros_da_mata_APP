...
class abrirPaginaHibisco extends StatefulWidget {

  @override
  State<abrirPaginaHibisco> createState() => _abrirPaginaHibiscoState();
}

class _abrirPaginaHibiscoState extends State<abrirPaginaHibisco> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaHibisco(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaHibisco extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaHibisco> createState() => _conteudoPaginaAbertaHibiscoState();
}

class _conteudoPaginaAbertaHibiscoState extends State<conteudoPaginaAbertaHibisco> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants hibisco = myBox.get('PANC4');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(hibisco.description,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: 'Antic',
                  color: Color.fromARGB(255, 84, 84, 84),
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(hibisco.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
