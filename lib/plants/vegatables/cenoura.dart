...
class abrirPaginaCenoura extends StatefulWidget {

  @override
  State<abrirPaginaCenoura> createState() => _abrirPaginaCenouraState();
}

class _abrirPaginaCenouraState extends State<abrirPaginaCenoura> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaCenoura(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaCenoura extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaCenoura> createState() => _conteudoPaginaAbertaCenouraState();
}

class _conteudoPaginaAbertaCenouraState extends State<conteudoPaginaAbertaCenoura> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants cenoura = myBox.get('vegetable2');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(cenoura.description,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(cenoura.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
