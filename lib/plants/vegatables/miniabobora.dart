...
class abrirPaginaMiniAbobora extends StatefulWidget {

  @override
  State<abrirPaginaMiniAbobora> createState() => _abrirPaginaMiniAboboraState();
}

class _abrirPaginaMiniAboboraState extends State<abrirPaginaMiniAbobora> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaMiniAbobora(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaMiniAbobora extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaMiniAbobora> createState() => _conteudoPaginaAbertaMiniAboboraState();
}

class _conteudoPaginaAbertaMiniAboboraState extends State<conteudoPaginaAbertaMiniAbobora> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants miniAbobora = myBox.get('vegetable4');
        ...
        child: Column(
          children: [
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(miniAbobora.developmentEta,
                      style: TextStyle(
                        color: Color.fromARGB(255, 87, 87, 87),
                        fontFamily: 'Antic',
                        fontSize: 15,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(miniAbobora.description,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(miniAbobora.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(miniAbobora.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(miniAbobora.planting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(miniAbobora.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
