...
class abrirPaginaPimentao extends StatefulWidget {

  @override
  State<abrirPaginaPimentao> createState() => _abrirPaginaPimentaoState();
}

class _abrirPaginaPimentaoState extends State<abrirPaginaPimentao> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaPimentao(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaPimentao extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaPimentao> createState() => _conteudoPaginaAbertaPimentaoState();
}

class _conteudoPaginaAbertaPimentaoState extends State<conteudoPaginaAbertaPimentao> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants pimentao = myBox.get('vegetable3');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(pimentao.description,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(pimentao.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(pimentao.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(pimentao.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
