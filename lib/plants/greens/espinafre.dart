...
class abrirPaginaEspinafre extends StatefulWidget {

  @override
  State<abrirPaginaEspinafre> createState() => _abrirPaginaEspinafreState();
}

class _abrirPaginaEspinafreState extends State<abrirPaginaEspinafre> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaEspinafre(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaEspinafre extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaEspinafre> createState() => _conteudoPaginaAbertaEspinafreState();
}

class _conteudoPaginaAbertaEspinafreState extends State<conteudoPaginaAbertaEspinafre> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants espinafre = myBox.get('greens4');
        ...
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(espinafre.description,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(espinafre.irrigation,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(espinafre.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(espinafre.replanting,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
