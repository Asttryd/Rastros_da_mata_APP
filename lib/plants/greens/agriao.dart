...
class abrirPaginaAgriao extends StatefulWidget {

  @override
  State<abrirPaginaAgriao> createState() => _abrirPaginaAgriaoState();
}

class _abrirPaginaAgriaoState extends State<abrirPaginaAgriao> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaAgriao(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaAgriao extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaAgriao> createState() => _conteudoPaginaAbertaAgriaoState();
}

class _conteudoPaginaAbertaAgriaoState extends State<conteudoPaginaAbertaAgriao> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants agriao = myBox.get('greens3');
        ...
        child: Column(
          children: [
           /*  Padding(padding: EdgeInsets.fromLTRB(20, 10, 20, 0),
              child: Text(agriao.observations,
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(agriao.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
