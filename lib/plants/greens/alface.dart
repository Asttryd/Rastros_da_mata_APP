...
class abrirPaginaAlface extends StatefulWidget {

  @override
  State<abrirPaginaAlface> createState() => _abrirPaginaAlfaceState();
}

class _abrirPaginaAlfaceState extends State<abrirPaginaAlface> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaAlface(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaAlface extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaAlface> createState() => _conteudoPaginaAbertaAlfaceState();
}

class _conteudoPaginaAbertaAlfaceState extends State<conteudoPaginaAbertaAlface> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants alface = myBox.get('greens1');
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(alface.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
