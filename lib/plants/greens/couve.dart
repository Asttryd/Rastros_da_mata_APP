...
class abrirPaginaCouve extends StatefulWidget {

  @override
  State<abrirPaginaCouve> createState() => _abrirPaginaCouveState();
}

class _abrirPaginaCouveState extends State<abrirPaginaCouve> {
              ...
              body: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: conteudoPaginaAbertaCouve(),
                    ),
                  ],
                ),
              ),
...
class conteudoPaginaAbertaCouve extends StatefulWidget {

  @override
  State<conteudoPaginaAbertaCouve> createState() => _conteudoPaginaAbertaCouveState();
}

class _conteudoPaginaAbertaCouveState extends State<conteudoPaginaAbertaCouve> {
  @override
  Widget build(BuildContext context) {
    writeData();
    Plants couve = myBox.get('greens2');
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Padding(padding: EdgeInsets.all(20.0),
              child: Text(couve.idealTemperature,
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 20,
                  fontFamily: 'Antic',
